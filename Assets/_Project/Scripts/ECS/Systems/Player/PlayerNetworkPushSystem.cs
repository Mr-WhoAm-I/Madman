...
namespace _Project.Scripts.ECS.Systems.Player
{
    ...
    [UpdateAfter(typeof(Classes.HystericSkillSystem))]
    [UpdateAfter(typeof(Classes.ParanoiacSkillSystem))]
    [UpdateAfter(typeof(Classes.SchizoidActiveSkillSystem))]
    [UpdateAfter(typeof(Classes.MelancholicActiveSkillSystem))]
